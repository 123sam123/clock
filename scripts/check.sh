...
node --input-type=module -e "await import('./src/timer.js'); await import('./src/chime.js'); await import('./src/notify.js'); await import('./src/completion.js'); await import('./src/session.js')"
